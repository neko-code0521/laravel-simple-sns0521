<div class="card mt-3">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <a class="dropdown-item text-danger" data-toggle="modal"
                                data-target="#modal-delete-<?php echo e($article->id); ?>">
    ...
    <div class="card-body pt-0 pb-2 pl-3">
        <div class="card-text">
            <article-like :initial-is-liked-by='<?php echo json_encode($article->isLikedBy(Auth::user()), 15, 512) ?>'
                :initial-count-likes='<?php echo json_encode($article->count_likes, 15, 512) ?>' :authorized='<?php echo json_encode(Auth::check(), 15, 512) ?>'
